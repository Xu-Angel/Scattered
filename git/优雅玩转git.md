...
- [如何优雅的玩转 Git](#如何优雅的玩转-git)
  ...
  - [2. 分支管理](#2-分支管理)
    - [2.1. Git Flow](#21-git-flow)
      - [2.1. 主干分支](#21-主干分支)
      - [2.2. `feature` 分支](#22-feature-分支)
      - [2.3. **`release` 分支**](#23-release-分支)
      - [2.4. `hotfix` 分支](#24-hotfix-分支)
      - [2.5. 如何应用 Git Flow](#25-如何应用-git-flow)
  ...
  - [4. Git 奇技淫巧](#4-git-奇技淫巧)
    ...
    - [4.5. Github Issue 和 Gitlab Issue](#45-github-issue-和-gitlab-issue)
      - [Github Issue 模板](#github-issue-模板)
      - [Gitlab Issue 模板](#gitlab-issue-模板)
    - [4.6. Git Hook](#46-git-hook)
      - [Javascript 应用 Git Hook](#javascript-应用-git-hook)
  - [5. 参考资料](#5-参考资料)
